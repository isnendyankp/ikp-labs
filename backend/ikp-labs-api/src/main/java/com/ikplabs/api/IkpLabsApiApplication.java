package com.ikplabs.api;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * Main Application Class untuk IKP Labs API
 *
...
public class IkpLabsApiApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(IkpLabsApiApplication.class, args);
    }
}