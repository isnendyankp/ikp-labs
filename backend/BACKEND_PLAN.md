...
- [ ] **Step 3.1:** Create UserService untuk business logic
- [ ] **Step 3.2:** Create UserController dengan endpoints
- [ ] **Step 3.3:** Create DTOs (UserRequest, UserResponse)
- [ ] **Step 3.4:** Implement user registration (tanpa password hashing)
- [ ] **Step 3.5:** Implement get user by ID
