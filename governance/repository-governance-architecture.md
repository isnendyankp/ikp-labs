...
├─────────────────────────────────────────────────┤
│  Layer 2  governance/principles/general.md      │
│           Values — what guides decisions        │
├─────────────────────────────────────────────────┤
│  Layer 3  governance/conventions/development.md │
│           Standards — naming, format, structure │
├─────────────────────────────────────────────────┤
│  Layer 4  governance/development/workflow/      │
│           Development — task types, commit      │
│           strategy, branch hygiene              │
├─────────────────────────────────────────────────┤
│  Layer 5  governance/development/agents/        │
│           Agent protocols — AI decision rules   │
│           and consultation order                │
├─────────────────────────────────────────────────┤
│  Layer 6  plans/                                │
...
**File:** `governance/vision/ikp-labs.md`
...
**File:** `governance/principles/general.md`
...
**File:** `governance/conventions/development.md`
...
**Directory:** `governance/development/`

Answers: **how do we execute work?**

Layer 4 covers task types (Code, Config, Meta, Infra) and the step-by-step procedures: branching, committing, PR creation, merging, deployment, and branch cleanup. See `governance/development/workflow/implementation.md`.

Layer 5 covers AI agent decision protocols — consultation order, prohibited actions, and code/plan/documentation protocols. See `governance/development/agents/ai-agent-guidelines.md`.

The quick-access alias `.workflow-template.md` at repo root points to the canonical path in `governance/development/workflow/implementation.md`.
...
For detailed AI agent protocols, see `governance/development/agents/ai-agent-guidelines.md`.
