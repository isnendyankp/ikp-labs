...
describe('PhotoUploadForm', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render drag & drop zone with instructions', () => {
      ...
      expect(screen.getByText(/click to select or drag & drop/i)).toBeInTheDocument();
    ...
    it('should render title input', () => {
      ...
      expect(screen.getByPlaceholderText(/enter photo title/i)).toBeInTheDocument();
    });
    ...
    it('should render description textarea', () => {
      ...
      expect(screen.getByPlaceholderText(/enter photo description/i)).toBeInTheDocument();
    });

    it('should render public checkbox', () => {
      renderWithProviders(<PhotoUploadForm />);

      expect(screen.getByLabelText(/make this photo public/i)).toBeInTheDocument();
    });
  ...
  describe('File Validation', () => {
    ...
    it('should show error for file size exceeding limit', async () => {
      ...
      const fileInput = document.querySelector('input[type="file"]') as HTMLInputElement;
      const largeFile = createImageFile('large.jpg', 'image/jpeg', 6 * 1024 * 1024); // 6MB
  ...
  describe('Image Preview', () => {
    ...
    it('should show file name and size when file is selected', async () => {
      ...
      const fileInput = document.querySelector('input[type="file"]') as HTMLInputElement;
      const validFile = createImageFile('my-photo.jpg', 'image/jpeg', 2048 * 100); // 200KB
      fireEvent.change(fileInput, { target: { files: [validFile] } });
  ...
  describe('Drag & Drop', () => {
    it('should handle drop event', async () => {
      ...
      const dropZone = screen.getByText(/click to select or drag & drop/i)
