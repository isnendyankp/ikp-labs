...
describe("EmptyState", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render string icon", () => {
      render(<EmptyState icon="📷" title="No photos" />);
    ...
    it("should render React node icon", () => {
      ...
      render(<EmptyState icon={<CustomIcon />} title="No items" />);
  ...
  describe("Action Button", () => {
    ...
    it("should not render action button when actionText is missing", () => {
      render(<EmptyState title="No photos" onAction={() => {}} />);

      expect(screen.queryByRole("button")).not.toBeInTheDocument();
    });

    it("should not render action button when onAction is missing", () => {
      render(<EmptyState title="No photos" actionText="Upload Photo" />);
  ...
  describe("Custom ClassName", () => {
    it("should apply custom className", () => {
      render(
        <EmptyState title="No data" className="custom-class another-class" />,
      );
  ...
  describe("Edge Cases", () => {
    it("should handle long title gracefully", () => {
      const longTitle =
        "This is a very long title that might overflow but should still render correctly";
    ...
    it("should handle long message gracefully", () => {
      const longMessage =
        "This is a very long description message that provides additional context about why there is no data to display and what the user can do to resolve this situation.";
      render(<EmptyState title="No data" message={longMessage} />);
    ...
    it("should render with all props", () => {
      ...
      expect(
        screen.getByText("Start by uploading your first photo"),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("button", { name: /upload photo/i }),
      ).toBeInTheDocument();
