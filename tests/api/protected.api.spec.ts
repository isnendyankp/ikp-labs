...
test.describe('Protected API Endpoints - JWT Authentication', () => {
  ...
  /**
   * Setup: Login to get valid token before all tests
   */
  test.beforeAll(async ({ request }) => {
    ...
    const loginResult = await authHelper.loginAndGetToken(
   ...
   */
  test('GET /api/user/profile - should return user profile with valid JWT', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('GET /api/user/profile - should reject request without JWT (401)', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('GET /api/user/profile - should reject invalid JWT token (401)', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('GET /api/user/profile - should reject malformed JWT (401)', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('GET /api/user/dashboard - should return dashboard with valid JWT', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('GET /api/user/dashboard - should reject request without JWT (401)', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('GET /api/user/settings - should return settings with valid JWT', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('GET /api/user/settings - should reject request without JWT (401)', async ({ request }) => {
    const client = new ApiClient(request);
   ...
   */
  test('Should access multiple protected endpoints with same JWT', async ({ request }) => {
    const client = new ApiClient(request);
    ...
    // Access dashboard
    const dashboardResponse = await client.get('/api/user/dashboard', validToken);
    ...
    console.log('✅ Test 10: Multiple protected endpoints accessible with same token');
  });
