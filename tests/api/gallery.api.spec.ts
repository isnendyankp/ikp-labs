...
test.describe("Gallery Photo API", () => {
  ...
  test.describe("GET /api/gallery/my-photos", () => {
    ...
    test("should get empty list when user has no photos", async ({
      request,
    }) => {
    ...
    test("should paginate correctly - page 1 (second page with remainder)", async ({
      request,
    }) => {
      const { token, userId } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
      ...
      const checkResponse = await client.get(
        "/api/gallery/my-photos?page=0&size=100",
        token,
      );
      ...
      const response = await client.get(
        "/api/gallery/my-photos?page=1&size=12",
        token,
      );
  ...
  test.describe("GET /api/gallery/public", () => {
    test("should get public photos with pagination", async ({ request }) => {
      ...
      // Get public photos
      const response = await client.get(
        "/api/gallery/public?page=0&size=12",
        token,
      );
    ...
    test("should return only public photos (excludes private)", async ({
      request,
    }) => {
      const { token, userId } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
      ...
      // Get public photos
      const response = await client.get(
        "/api/gallery/public?page=0&size=50",
        token,
      );
      ...
      const userPhotos = response.body.photos.filter(
        (photo: any) => photo.userId === userId,
      );

      // Verify we can find the public photos we just uploaded
      const publicTestPhotos = userPhotos.filter((photo: any) =>
        photo.title.includes("Public Test"),
      );
      ...
      const privatePhotos = userPhotos.filter((photo: any) =>
        photo.title.includes("Private Test"),
      );
      expect(privatePhotos.length).toBe(0);
    });

    test("should get public photos from multiple users", async ({
      request,
    }) => {
      ...
      const userAPhotos = response.body.photos.filter(
        (photo: any) => photo.userId === userA.userId,
      );
      const userBPhotos = response.body.photos.filter(
        (photo: any) => photo.userId === userB.userId,
      );
  ...
  test.describe("GET /api/gallery/photo/:id", () => {
    test("should get public photo by anyone (non-owner can access)", async ({
      request,
    }) => {
    ...
    test("should get private photo by owner (owner can access)", async ({
      request,
    }) => {
      const { token, userId } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should fail to get private photo by non-owner (403 Forbidden)", async ({
      request,
    }) => {
    ...
    test("should return complete photo detail structure", async ({
      request,
    }) => {
      const { token, userId } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
  ...
  test.describe("PUT /api/gallery/photo/:id", () => {
    test("should update photo title only (partial update)", async ({
      request,
    }) => {
      const { token, userId } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should update photo description only (partial update)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should update isPublic only (privacy toggle)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should fail update by non-owner (403 Forbidden)", async ({
      request,
    }) => {
      ...
      const checkResponse = await clientA.get(
        `/api/gallery/photo/${photoId}`,
        userA.token,
      );
    ...
    test.fixme("should fail update without authentication (403 Forbidden)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should fail update non-existent photo (404 Not Found)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should fail update with title too long (400 Bad Request)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
      ...
      expect(
        updateResponse.body.message || updateResponse.body.error,
      ).toBeTruthy();
    });

    test("should fail update with description too long (400 Bad Request)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should update successfully with empty request body (no-op)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
  ...
  test.describe("DELETE /api/gallery/photo/:id", () => {
    test("should delete photo by owner (204 No Content)", async ({
      request,
    }) => {
      const { token, userId } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
      ...
      const myPhotosResponse = await client.get(
        "/api/gallery/my-photos?page=0&size=100",
        token,
      );
      const deletedPhoto = myPhotosResponse.body.photos.find(
    ...
    test("should fail delete by non-owner (403 Forbidden)", async ({
      request,
    }) => {
      // User A uploads photo
      const userA = await getAuthenticatedUser(request);
      ...
      const deleteResponse = await clientB.delete(
        `/api/gallery/photo/${photoId}`,
        userB.token,
      );
    ...
    test("should fail delete non-existent photo (404 Not Found)", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
    ...
    test("should delete multiple photos and verify my-photos updates", async ({
      request,
    }) => {
      const { token } = await getAuthenticatedUser(request);
      const client = new ApiClient(request);
      ...
      for (const photoId of photoIds) {
        const photo = afterResponse.body.photos.find(
          (p: any) => p.id === photoId,
        );
  ...
  test.describe("Gallery Sorting API", () => {
    test.describe("GET /api/gallery/public with sortBy parameter", () => {
      test("API-SORT-001: should sort public photos by newest (default)", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/public?page=0&size=12&sortBy=newest",
          token,
        );
      ...
      test("API-SORT-002: should sort public photos by oldest", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/public?page=0&size=12&sortBy=oldest",
          token,
        );
      ...
      test("API-SORT-003: should sort public photos by mostLiked", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/public?page=0&size=12&sortBy=mostLiked",
          token,
        );
        ...
        for (let i = 0; i < photos.length - 1; i++) {
          expect(photos[i].likeCount).toBeGreaterThanOrEqual(
            photos[i + 1].likeCount,
          );
        }
      });

      test.fixme("API-SORT-004: should sort public photos by mostFavorited", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/public?page=0&size=12&sortBy=mostFavorited",
          token,
        );
        ...
        for (let i = 0; i < photos.length - 1; i++) {
          expect(photos[i].favoriteCount).toBeGreaterThanOrEqual(
            photos[i + 1].favoriteCount,
          );
        }
      });

      test("API-SORT-005: should default to newest when sortBy parameter is missing", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
      ...
      test("API-SORT-006: should return 400 for invalid sortBy parameter", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/public?page=0&size=12&sortBy=invalidOption",
          token,
        );
    ...
    test.describe("GET /api/gallery/my-photos with sortBy parameter", () => {
      test("API-SORT-007: should sort my photos by newest", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/my-photos?page=0&size=12&sortBy=newest",
          token,
        );
      ...
      test("API-SORT-008: should sort my photos by oldest", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/my-photos?page=0&size=12&sortBy=oldest",
          token,
        );
      ...
      test("API-SORT-009: should sort my photos by mostLiked", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/my-photos?page=0&size=12&sortBy=mostLiked",
          token,
        );
      ...
      test("API-SORT-010: should sort my photos by mostFavorited", async ({
        ...
        const response = await client.get(
          "/api/gallery/my-photos?page=0&size=12&sortBy=mostFavorited",
          token,
        );
    ...
    test.describe("Pagination with Sorting", () => {
      test("API-SORT-011: should maintain sort order across pagination pages", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const page0Response = await client.get(
          "/api/gallery/public?page=0&size=12&sortBy=newest",
          token,
        );

        // Get page 1 sorted by newest
        const page1Response = await client.get(
          "/api/gallery/public?page=1&size=12&sortBy=newest",
          token,
        );
        ...
        if (page0Photos.length > 0 && page1Photos.length > 0) {
          const lastPage0 = new Date(
            page0Photos[page0Photos.length - 1].createdAt,
          ).getTime();
      ...
      test("API-SORT-012: should work with empty results", async ({
        request,
      }) => {
        // Create new user with no photos
        const client = new ApiClient(request);
    ...
    test.describe("Data Integrity with Sorting", () => {
      test.fixme("API-SORT-013: should include correct like and favorite counts", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
      ...
      test("API-SORT-014: should include user-specific flags (isLikedByUser, isFavoritedByUser)", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
    ...
    test.describe("Response Performance", () => {
      test("API-SORT-015: should respond within acceptable time (< 1000ms)", async ({
        request,
      }) => {
        const { token } = await getAuthenticatedUser(request);
        const client = new ApiClient(request);
        ...
        const response = await client.get(
          "/api/gallery/public?page=0&size=25&sortBy=mostLiked",
          token,
        );
