...
public class UserProfileControllerIntegrationTest {
    ...
    private String registerUserAndGetToken(String email, String fullName) throws Exception {
        ...
        when(userRepository.findByEmail(email))
                ...
                .thenAnswer(invocation -> {
                    ...
                    com.ikplabs.api.entity.User savedUser = new com.ikplabs.api.entity.User(fullName, email, "$2a$10$encodedPassword");
                    savedUser.setId(1L);
        ...
        when(userRepository.save(any())).thenAnswer(invocation -> {
            com.ikplabs.api.entity.User user = invocation.getArgument(0);
            if (user != null) {
                user.setId(1L);
            }
            return user;
    ...
    void testJwtAuthenticationFlow_EndToEnd() throws Exception {
        ...
        when(userRepository.findByEmail("e2e@test.com"))
                ...
                .thenAnswer(invocation -> {
                    // Subsequent calls dari JWT filter - return saved user
                    com.ikplabs.api.entity.User savedUser = new com.ikplabs.api.entity.User("EndToEnd Test User", "e2e@test.com", "$2a$10$encodedPassword");
                    savedUser.setId(1L);
                    return java.util.Optional.of(savedUser);
                });
