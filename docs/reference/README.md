...
**Information-oriented documentation** - Technical specifications, API documentation, and reference materials.

## What is Reference Documentation?

Reference documentation provides dry, factual information about the system. It describes the machinery and how to use it accurately and completely.
